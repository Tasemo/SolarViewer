...
% Vorteil: keine Probleme aus Programsicht, die gesamte Lo
% Vorteil: kein Fenster- und OpenGL-Kontext-Management. Normalerweise hätte dafür ein eigenes Framework integriert werden müssen (z.B. GLFW), da dies natürlich Betriebssystemabhängig ist und eine Anpassung an alle möglichen Systeme ein immenser Arbeitsaufwand ist. Auch Benutzereingaben über Maus und Tastatur abgedeckt, was in nativen Anwendungen immer mit einigem Aufwand verbunden ist.
