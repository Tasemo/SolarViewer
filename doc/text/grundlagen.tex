...
% ocllusion culling, also das Entfernen von Daten, die durch andere Daten verdeckt werden
...
% hilft nicht nur dabei die Datemenge zu reduzieren, auch für die Rendering-Performance sehr hilfreich: wie beschrieben wird die gesamte Render-Pipeline, inklusive Ausführung von Vertex- und Fragment-Shader, bevor einzelne Pixel, welche nicht auf dem Bildschirm liegen oder von anderen verdeckt sind, verworfen werden
% da ganze Modelle mit tausenden von Vertices vorher auszuschleießen also positiv
...
% auch alternative Verfahren zur verlustbehafteten Reduktion sind möglich, Mesh Simplification
